...
- [x] Implement `parse_if()` method
- [x] Parse "if" keyword and condition
- [x] Parse colon
- [x] Parse indented block (INDENT...DEDENT)
- [x] Parse elif chains (zero or more)
- [x] Parse optional else block
...
- [x] Test: if-else
- [x] Test: if-elif-else
- [x] Test: Multiple elif
- [x] Test: Nested if
- [x] Test: If with multiple statements in blocks
- [x] Error tests: Missing colon, missing block, etc.
